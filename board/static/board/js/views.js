(function ($, Backbone, _, app){
    ...
    var FormView = TemplateView.extend({
        ...
        showErrors: function(errors){
            _.map(errors, function(fieldErrors, name){
                ...
                _.map(fieldErrors, appendErr, this);
            }, this);
        },
    ...
    var HomepageView = TemplateView.extend({
      ...
      initialize: function(options){
          ...
          app.collections.ready.done(function(){
              var endmin = new Date();
              endmin.setDate(endmin.getDate() - 7);
              endmin = endmin.toISOString().replace(/T.*/g, '');
              app.sprints.fetch({
                  data: {end_min: endmin},
    ...
    var SprintView = TemplateView.extend({
        ...
        remove: function () {
            TemplateView.prototype.remove.apply(
                this, arguments);
    ...
    var LoginView = FormView.extend({
      ...
      showErrors: function(errors){
          _.map(errors, function(fieldErrors, name){
              ...
              _map(fieldErrors, appendErr, this);
              }, this);
         },
      clearErrors: function (){
              $('.error', this.form).remove();
    ...
    var HeaderView = TemplateView.extend({
        ...
        events: {
            'click a.logout.button': 'logout'   // To be raised with O'reilly
        },
        getContext: function(){
